...
archive: test
	(mkdir -p ../tar; cd ..; tar czvf tar/LessGenerators.tar.gz --exclude ".DS_Store" --exclude "*~" LessGenerators/doc/*.* LessGenerators/doc/clean LessGenerators/gap/*.{gi,gd} LessGenerators/{CHANGES,PackageInfo.g,README,VERSION,init.g,read.g,makedoc.g,makefile,maketest.g,ListOfDocFiles.g,createautodoc.g} LessGenerators/examples/*.g)

WEBPOS=public_html
WEBPOS_FINAL=~/public_html/LessGenerators
