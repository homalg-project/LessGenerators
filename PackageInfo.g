#############################################################################
##  
##  PackageInfo.g for the package `LessGenerators'           Mohamed Barakat
##                                                            Anna Fabiańska
##                                                                Vinay Wagh
##
...
Version := Maximum( [
  "2013.07.17", ## Mohamed's version
## this line prevents merge conflicts
  "2013.07.18", ## Vinay's version
] ),
...
# 
ArchiveURL := Concatenation( "http://homalg.math.rwth-aachen.de/~barakat/homalg-project/LessGenerators-", ~.Version ),
...
#
README_URL := 
  "http://homalg.math.rwth-aachen.de/~barakat/homalg-project/LessGenerators/README.LessGenerators",
PackageInfoURL := 
  "http://homalg.math.rwth-aachen.de/~barakat/homalg-project/LessGenerators/PackageInfo.g",
...
#  "----------------------------------------------------------------\n",
#  "Loading  LessGenerators ", ~.Version, "\n",
...
#        " (", ~.Persons[3].WWWHome, ")\n",
#  "For help, type: ?LessGenerators package \n",
#  "----------------------------------------------------------------\n" ),
#
