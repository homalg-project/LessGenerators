...
##  [ (1/4*x^5-1/2), (x^5-6)/(4*x^2)*y+(x^5-6)/(8*x^2), (-x^5+6)/(4*x^2), (x^7)*y+(-1/2*x^7+x^2), (x^5)*y^2+y+(-1/4*x^5+3/2), (-x^5)*y+(1/2*x^5-1), (-x^2), -y-1/2, 1 ]
##  gap> EntriesOfHomalgMatrix( H2[2] );
##  [ 1, 0, (x^5-6)/(4*x^2), 0, 1, (x^5)*y+(-1/2*x^5+1), (x^2), y+1/2, (x^5)*y^2+y ]
...
##  [ 1, 1/8*x^8*y+1/2*x^5*y-3/4*x^3*y-y, -1/16*x^13*y-1/4*x^10*y+1/2*x^8*y+x^5*y-3/4*x^3*y-y, 0, 1/2*x^10*y^2-1/4*x^10*y+2*x^7*y^2-x^7*y-2*x^5*y^2+3/2*x^5*y+2*x^2*y-2*y+1, -1/4*x^15*y^2+1/8*x^15*y-x^12*y^2+1/2*x^12*y+3/2*x^10*y^2-x^10*y+2*x^7*y^2-2*x^7*y-2*x^5*y^2+3/2*x^5*y+2*x^2*y-2*y, 0, -1/2*x^5*y-2*x^2*y+2*y, 1/4*x^10*y+x^7*y-3/2*x^5*y-2*x^2*y+2*y+1 ]
